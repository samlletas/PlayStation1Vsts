...
def main():
  ...
  plistpath = scriptpath + "/resources/PsxReverb-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxReverb-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxReverb-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxReverb-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxReverb-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/PsxReverb.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/PsxReverb.iss",inplace=1):
