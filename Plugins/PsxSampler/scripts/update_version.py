...
def main():
  ...
  plistpath = scriptpath + "/resources/PsxSampler-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxSampler-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxSampler-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxSampler-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PsxSampler-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/PsxSampler.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/PsxSampler.iss",inplace=1):
