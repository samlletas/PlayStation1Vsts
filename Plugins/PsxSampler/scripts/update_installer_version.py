...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PsxSampler Demo Installer\n"
      else:
        line="OutputBaseFilename=PsxSampler Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PsxSampler Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PsxSampler installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PsxSampler Demo installer\n"
     else:
       line="SetupWindowTitle=PsxSampler installer\n"
