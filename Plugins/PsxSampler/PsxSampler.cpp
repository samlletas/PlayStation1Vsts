...
PsxSampler::PsxSampler(const InstanceInfo& info)
...
#if IPLUG_DSP
void PsxSampler::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void PsxSampler::OnIdle()
{
  mMeterSender.TransmitData(*this);
  mLFOVisSender.TransmitData(*this);
}

void PsxSampler::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void PsxSampler::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void PsxSampler::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool PsxSampler::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
